...
(function () {
    ...
    AP.prototype = {
        ...
        /**
         * Return namespace for the current project
         * It works exactly same as namespace method but it adds "Project" word at the beginning of the specified argument
         * @method project
         * @param {String} name name of the project
         * @return {Object} A reference to the project namespace
         */
        project : function (name) {
            return this.namespace('Project.' + name);
        },
